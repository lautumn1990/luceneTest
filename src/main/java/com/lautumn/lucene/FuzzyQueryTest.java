...
public class FuzzyQueryTest {
    ...
    public void personToIndex(){
        ...
        try {
            ...
            //获取personList
            List<Person> personList = getPersons(14);
            //存index
    ...
    public List<Person> getPersons(int n) {
        ...
        String[][] personString = getPersonString(n);
    ...
    public String[][] getPersonString(int N){
    ...
    public List<Person> getPersonsByKeyword(String keywords, Integer ageLow,Integer ageHigh){
...
//                keyWords.split(" ")) + "~";
        ...
        try {
//            parser.setFuzzyPrefixLength(5);
            parser.setAllowLeadingWildcard(true);
//            parser.setFuzzyPrefixLength(0);
//            parser.setFuzzyMinSim(10);
...
//        System.out.println(replaceEnglishWord("中国 高速 busii 你好 agcs  agd fsda 令计划"));
    ...
    public static void testHighlight() throws IOException, InvalidTokenOffsetsException {
